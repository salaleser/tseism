...
function Color:new()
	...
	self.canary = {1, 1, 153/255, 1}
	self.cherry = {222/255, 49/255, 99/255, 1}
	self.corn = {251/255, 236/255, 93/255, 1}
	self.cornflower = {154/25, 206/255, 235/255, 1}
	self.cream = {1, 253/255, 208/255, 1}
	self.darkGray = {169/255, 169/255, 169/255, 1}
	self.eggShell = {240/255, 234/255, 214/255, 1}
	self.emerald = {80/255, 200/255, 120/255, 1}
	self.iris = {90/255, 79/255, 207/255, 1}
	self.lemon = {1, 247/255, 0, 1}
	self.scarlet = {1, 36/255, 0, 1}
	self.vermilion = {227/255, 66/255, 52/255, 1}
end